...
What is the difference between "42" and 42.
 ...
 - Answer: "42 is counted as an alpha numerican and not a number while just 42 is an integer

Define the boolean operators: >, <, ==, >=, <=

 - Answer:> is more than < is less than == is equal to >= is more or equal than <= is less or equal than
 and they are used to compare two variables with their string/array lenght or number value.
...
What is the first index of a list? Why?
 ...
 - Answer: it is 0 because the array number determines the offset from the memory, starting at 0
